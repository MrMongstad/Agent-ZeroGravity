...
function ProgressBar({ percent }: { percent: number }) {
  ...
  return (
    ...
    >
      ...
      <div className="h-3 bg-muted/40 rounded-full overflow-hidden print:bg-gray-200"
        role="progressbar"
...
<title>${projectName} â€” Milestone Report</title>
<style>
...
<body>
<div class="header">
  <h1>${projectName} â€” Milestone Report</h1>
...
export default function Reports() {
  ...
  return (
    <>
      {/* Inline print styles â€” hides chrome, resets to B&W where needed, but preserves functional colors */}
      <style>{`
        @media print {
          ...
          * {
          ...
          /* Enforce Pristine Light Mode aesthetics globally for PDF */
          body, html, #root, main, .bg-background, [data-theme="dark"] {
          ...
          .text-foreground, p, span, h1, h2, h3, div { color: #111827 !important; }
      ...
      <div className="p-6 lg:p-8 space-y-8 min-h-full">
        ...
        <div className="hidden print:block border-b border-gray-300 pb-4 mb-2">
          <h1 className="text-xl font-bold text-black">
            NorCast Planner â€” Project Reports
          </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
          ...
          <StatCard
            ...
            icon={Calendar}
            sub={kickoffDate ? formatDate(sorted[0].date) : "â€”"}
            delay={0.2}
          />
          <StatCard
