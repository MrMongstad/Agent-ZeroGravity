...
function fireConfetti(): () => void {
  ...
  // Return cleanup fn — call this to cancel mid-animation
  return () => {
    cancelled = true;
  ...
  return (
    <div className="p-5 lg:p-8 space-y-6 min-h-full">
      ...
      <motion.div
        ...
        className="glass-card rounded-2xl p-6 flex flex-col sm:flex-row items-center gap-6 cursor-default"
      ...
      >
        ...
        <div className="flex-1 min-w-0 space-y-4 text-center sm:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 pt-2">
            <div className="bg-background/40 rounded-2xl p-4 flex items-center gap-4 border border-border/40 min-w-[160px] shadow-[3px_-2px_15px_1px_rgba(20,20,20,0.22),0_12px_25px_-6px_rgba(0,0,0,0.4)] hover:scale-[1.01] hover:-translate-y-0.5 transition-all duration-300 ease-out">
              ...
              <div>
                <p className="text-[11px] text-muted-foreground font-semibold mb-1 uppercase tracking-[0.08em]">
                  Completed
                </p>
                <p className="font-display font-black text-2xl leading-none text-emerald-500 tabular-nums">
                  {displayCompleted}
                </p>
              </div>
            </div>
            ...
            <div className="bg-background/40 rounded-2xl p-4 flex items-center gap-4 border border-border/40 min-w-[160px] shadow-[3px_-2px_15px_1px_rgba(20,20,20,0.22),0_12px_25px_-6px_rgba(0,0,0,0.4)] hover:scale-[1.01] hover:-translate-y-0.5 transition-all duration-300 ease-out">
              ...
              <div>
                ...
                <p className="font-display font-black text-2xl leading-none text-amber-500 tabular-nums">
                  {displayRemaining}
                </p>
              </div>
            </div>
