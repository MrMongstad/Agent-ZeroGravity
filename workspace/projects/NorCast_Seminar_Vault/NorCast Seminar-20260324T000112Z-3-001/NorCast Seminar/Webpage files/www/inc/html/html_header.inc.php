...
<body class="<?php 
  if (isset($_GET['page']))
  {
    $page = $_GET['page']; if ($page == "0" || !$page) { echo "homepage"; } else { echo "no-sidebar"; }
  }
  else { echo "homepage"; }
  ?>">
